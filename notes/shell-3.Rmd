...
subtitle: "Notes #3: loops & scripts"
author:
 - name: Paul Johnson
   affiliation: Center for Research Methods and Data Analysis, University of Kansas
   email: pauljohn@ku.edu
 - name: "CRMDA Guide #41. Please visit [http://crmda.ku.edu/guides](http://crmda.ku.edu/guides) for updates."
 - name: "Tags: command line, script, for loop"
abstract:
   This discusses shell scripting.  It illustrates  a simple for loop
   that handles repeated data processing chores when there are
   many files to be considered.
checked_by: "First Last"
Note to Authors: please_dont_change_the_next 4 lines!
date: "`r format(Sys.time(), '%Y %B %d')`"
output:
  html_document:
    css: ~/R/x86_64-pc-linux-gnu-library/3.3/crmda/extdata/theme/kutils.css
    highlight: haddock
    keep_md: yes
    toc: yes
---
