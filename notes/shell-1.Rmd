...
### Go back one level and retrieve that directory in there
```{r}
cd ..
pwd
## mv ~/success  .
...
"**.**": is shorthand for here!, the current working directory
...
# `cp` is for Copy: suprisingly different from move
...
`rm`, `mv`, `cp`: remove, move and copy directories and files
